...
def KitModel(weight_file = None):
    ...
    init_Pad        = layers.ZeroPadding2D(name='init/Pad', padding=((0, 0), (3, 3)))(transpose)
    init_init_conv_conv2d_Conv2D = convolution(weights_dict, name='init/init_conv/conv2d/Conv2D', input=init_Pad, group=1, conv_type='layers.Conv2D', filters=64, kernel_size=(7, 7), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_0_block_0_conv1_b1_conv2d_Conv2D = convolution(weights_dict, name='stages_0_block_0/conv1_b1/conv2d/Conv2D', input=stages_0_block_0_Pad, group=1, conv_type='layers.Conv2D', filters=256, kernel_size=(1, 1), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_0_block_0_Pad_1 = layers.ZeroPadding2D(name='stages_0_block_0/Pad_1', padding=((0, 0), (1, 1)))(stages_0_block_0_Relu_2)
    stages_0_block_0_conv2_b2_conv2d_Conv2D = convolution(weights_dict, name='stages_0_block_0/conv2_b2/conv2d/Conv2D', input=stages_0_block_0_Pad_1, group=1, conv_type='layers.Conv2D', filters=64, kernel_size=(3, 3), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_1_block_0_conv1_b1_conv2d_Conv2D = convolution(weights_dict, name='stages_1_block_0/conv1_b1/conv2d/Conv2D', input=stages_1_block_0_Pad, group=1, conv_type='layers.Conv2D', filters=512, kernel_size=(1, 1), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_1_block_0_Pad_1 = layers.ZeroPadding2D(name='stages_1_block_0/Pad_1', padding=((0, 0), (1, 1)))(stages_1_block_0_Relu_2)
    stages_1_block_0_conv2_b2_conv2d_Conv2D = convolution(weights_dict, name='stages_1_block_0/conv2_b2/conv2d/Conv2D', input=stages_1_block_0_Pad_1, group=1, conv_type='layers.Conv2D', filters=128, kernel_size=(3, 3), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_2_block_0_conv1_b1_conv2d_Conv2D = convolution(weights_dict, name='stages_2_block_0/conv1_b1/conv2d/Conv2D', input=stages_2_block_0_Pad, group=1, conv_type='layers.Conv2D', filters=1024, kernel_size=(1, 1), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_2_block_0_Pad_1 = layers.ZeroPadding2D(name='stages_2_block_0/Pad_1', padding=((0, 0), (1, 1)))(stages_2_block_0_Relu_2)
    stages_2_block_0_conv2_b2_conv2d_Conv2D = convolution(weights_dict, name='stages_2_block_0/conv2_b2/conv2d/Conv2D', input=stages_2_block_0_Pad_1, group=1, conv_type='layers.Conv2D', filters=256, kernel_size=(3, 3), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_3_block_0_conv1_b1_conv2d_Conv2D = convolution(weights_dict, name='stages_3_block_0/conv1_b1/conv2d/Conv2D', input=stages_3_block_0_Pad, group=1, conv_type='layers.Conv2D', filters=2048, kernel_size=(1, 1), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    stages_3_block_0_Pad_1 = layers.ZeroPadding2D(name='stages_3_block_0/Pad_1', padding=((0, 0), (1, 1)))(stages_3_block_0_Relu_2)
    stages_3_block_0_conv2_b2_conv2d_Conv2D = convolution(weights_dict, name='stages_3_block_0/conv2_b2/conv2d/Conv2D', input=stages_3_block_0_Pad_1, group=1, conv_type='layers.Conv2D', filters=512, kernel_size=(3, 3), strides=(1, 2), dilation_rate=(1, 1), padding='valid', use_bias=None)
    ...
    global_pool_Mean = layers.Lambda(lambda x: K.mean(x, axis=[2, 3], keepdims=True))(global_pool_Relu)
